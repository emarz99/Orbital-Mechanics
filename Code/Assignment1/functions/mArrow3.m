...
%Thsi functions plot a 3D arrow as patch object (cylinder+cone). This is a
%slightly modified function obtained in Matlab File Exchange. Original Author and
%credits go to Georg Stillfried. 
%
% PROTOTYPE:    h = mArrow3(p1,p2)
%               h = mArrow3(p1,p2,'propertyName',propertyValue,...)
%
% INPUT:    p1[3]:         starting point
%           p2[3]:         end point
...
%
% OUTPUT:
%           figure of specified arrow vector with its selected properties
%
% CONTRIBUTORS:
%           Georg Stillfried
%
...
%
% CITATION:
% Georg Stillfried (2023). mArrow3.m - easy-to-use 3D arrow 
% (https://www.mathworks.com/matlabcentral/fileexchange/25372-marrow3-m-easy-to-use-3d-arrow), 
% MATLAB Central File Exchange. Retrieved January 3, 2023.
